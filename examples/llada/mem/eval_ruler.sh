...
# RULER custom datasets in this lm_eval fork read tokenizer/pretrained from task metadata.
# If user didn't provide either key in metadata, inject pretrained automatically.
